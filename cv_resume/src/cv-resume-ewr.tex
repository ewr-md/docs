...
\newcommand{\fellowshipClinical}{University of Maryland}
\newcommand{\fellowshipResearch}{Critical Care Medicine \& Pulmonary Branch, NHLBI / NIH}
...
\newcommand{\address}{10201 Grosvenor Place, Apt \#1217, Rockville, MD 20852}
\newcommand{\email}{ewrobbins@outlook.com}
...
\begin{document}
	...
	\entryfour{7/2026 -- Present}
	{Clinical Fellow: Suffredini Lab}
	{\fellowshipResearch}
	{}
		
	\entryfour{7/2023 -- 6/2026}
  {Fellowship: Pulmonary \& Critical Care Medicine}
	{National Heart, Lung, and Blood Institute / \fellowshipClinical}
	{}
	
	\entryfour{6/2020 -- 6/2023}
	...
	\section*{Clinical Work Experience}
		...
		\entryfour{1/2025 -- 6/2026}
		{Overnight Oncology Coverage Provider}
		{University of Maryland, BMT \& Oncology Service}
		{}
...
%		Mentor: Bradley Maron, MD. PI: Katarina Zeder, MD, PhD.
	\subsection*{Grants}
		\entryfour{4/2026 -- 4/2027}{A Collaborative Framework for Harmonized Autoantibody and Proteomic Integration Across Systemic Autoimmune Rheumatic Diseases Using ADAPTS}{OADR-I-26-006}{\\NIH, OADR-ORWH\\ Award: \$100,000\\Role: Key personnel (PI: Suffredini)}
...
%		Pulmonary Vascular Research Institute\\
	...
	\section*{Committees and Other Appointments}
		...
		\entryfour{12/2021 -- 6/2023}{Affiliate Reviewer}{medRxiv}{%
			% \begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%
	...
	\entryfour{3/2026}{Top 10\% Abstract}{2026 NHLBI Intraural Research Day}{}
