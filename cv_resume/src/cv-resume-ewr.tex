...
\usepackage[sorting=ydnt, url=false, style=ieee, minbibnames=5, maxbibnames=5, defernumbers=true, backend=bibtex]{biblatex}
...
\newcommand{\email}{\href{mailto:erobbins.md@protonmail.com}{erobbins.md@protonmail.com}}
...
%	}
		...
		\entryfour{9/2013 -- 8/2016}{Copyeditor}{Cell Press, RELX Group}{%
			% \begin{itemize}
			% 	\item Copyedited manuscripts for \emph{Molecular Cell}, \emph{Cell Metabolism}, \emph{Cell Host and Microbe}, and \emph{Neuron}
...
%%%%%%%%%%%%%%%%%%%%%%%
	...
	\entryfour{12/2018}{Lahey Top Gun}{Lahey Hospital and Medical Center}{%
		% \begin{itemize}
