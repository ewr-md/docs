...
\address{
	\includegraphics[height=7em]{\logo} % Include the logo of author institution
...
\signature{\Who\Title 
	\\
	Class of 2020, Tufts University School of Medicine
	\\
	PGY-4 Fellow, Pulmonary and Critical Care Medicine
	\\
	University of Maryland / NHLBI \& NIH
	} % The signature is a combination of the author's name and title
...
\renewcommand{\closing}[1]{
	...
	\noindent % Stop paragraph indentation
		...
		\vskip 0.2em % Whitespace between the closing text and author's name for a physical signature
		\includegraphics[height=3.5em]{sig.png}
		\vskip 0.2em % Whitespace between the closing text and author's name for a physical signature		
