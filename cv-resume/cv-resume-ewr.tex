...
\usepackage[natbib=true, style=numeric, sorting=ynt, url=false]{biblatex}
\addbibresource{../../bibtex-sync/cv-ewr.bib}
...
\begin{document}
	...
	%\nocite{Robbins2020,Robbins2020a,Robbins2020b,Robbins2022}
	%\printbibliography
